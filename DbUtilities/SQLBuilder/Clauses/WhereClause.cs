...
namespace CodeEngine.Framework.QueryBuilder
{
    ...
    public struct WhereClause
    {
        ...
        /// <summary>
        /// WHERE 从句：Age>10 AND Name Like '陈'%
        /// </summary>
        /// <param name="field">字段名</param>
        /// <param name="firstCompareOperator">比较符</param>
        /// <param name="firstCompareValue">字段值</param>
        ...
        /// <summary>
        /// 添加 WHERE 子从句：Age > 10 AND Age <20
        /// </summary>
        /// <param name="logic">逻辑符号： AND 或 OR</param>
        /// <param name="compareOperator">比较符</param>
